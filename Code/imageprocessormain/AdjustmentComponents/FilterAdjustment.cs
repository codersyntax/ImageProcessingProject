...
namespace ImageProcessorMain.AdjustmentComponents
{
    internal class FilterAdjustment
    {
        ...
        internal FilterAdjustment(Form mainForm, ImageHandler imageHandler, ImageHub imageHub)
        {
            m_MainForm = mainForm;
        ...
        public Form ShowDialog()
        {
            ...
            m_FilterDialog.Size = new Size(210, 240);
        ...
        private void CreateDialogOkButton()
        {
            ...
            m_OkButton.Left = (m_FilterDialog.Width - m_OkButton.Width) / 2;
            m_OkButton.Top = 165;
